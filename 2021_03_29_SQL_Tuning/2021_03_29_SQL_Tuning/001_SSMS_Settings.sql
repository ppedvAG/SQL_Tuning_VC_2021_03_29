...
F5 - Execute
STRG + E - execute highlighted Query
...
STRG + K, STRG + C - Auskommentieren
STRG + K, STRG + U - Uncomment

STRG + N - neuer Query-Tab
...
STRG + K, STRG + K - Bookmark setzen
STRG + K, STRG + P - gehe zu vorherigem Bookmark
STRG + K, STRG + N - gehe zu nächstem Bookmark
